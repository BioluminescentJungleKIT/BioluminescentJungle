...
void JungleApp::createInstance() {
    ...
    appInfo.pApplicationName = "Jungle";
...
void JungleApp::setupDebugMessenger() {
...
void JungleApp::pickPhysicalDevice() {
...
bool JungleApp::isDeviceSuitable(VkPhysicalDevice const &device) {
...
JungleApp::QueueFamilyIndices JungleApp::findQueueFamilies(VkPhysicalDevice device) {
...
void JungleApp::createLogicalDevice() {
    QueueFamilyIndices indices = findQueueFamilies(physicalDevice);
...
bool JungleApp::checkDeviceExtensionSupport(VkPhysicalDevice const &device) {
...
JungleApp::SwapChainSupportDetails JungleApp::querySwapChainSupport(VkPhysicalDevice device) {
...
void JungleApp::createVertexBuffer() {
...
void JungleApp::createIndexBuffer() {
    ...
    void *data;
    vkMapMemory(device, stagingBufferMemory, 0, bufferSize, 0, &data);
    memcpy(data, vertex_indices.data(), (size_t) bufferSize);
    vkUnmapMemory(device, stagingBufferMemory);
...
void JungleApp::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties,
...
void JungleApp::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    VkCommandBufferAllocateInfo allocInfo{};
    allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
    allocInfo.commandPool = commandPool;
...
uint32_t JungleApp::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
