...
bool VulkanDevice::isDeviceSuitable(VkPhysicalDevice const& device, VkSurfaceKHR surface)
{
...
bool VulkanDevice::checkDeviceExtensionSupport(VkPhysicalDevice const& device) {
    ...
    VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
{
    ...
    allocInfo.memoryTypeIndex =
        VulkanHelper::findMemoryType(physicalDevice, memRequirements.memoryTypeBits, properties);
...
VkImageView VulkanDevice::createImageView(VkImage image, VkFormat format, VkImageAspectFlags flags)
{
...
void VulkanDevice::transitionImageLayout(VkImage image,
    VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, VkImageAspectFlags aspectMask)
{
